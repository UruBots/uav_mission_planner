...
RUN apt-get update && apt-get dist-upgrade -y && apt-get install -y \
    python3 python3-pip libopencv-dev python3-opencv libzbar0 && \
...
ADD ./gate_system /home/drone/catkin_ws/src/gate_system
...
# RUN source /opt/ros/noetic/setup.bash && roslaunch mrs_uav_gazebo_simulation simulation.launch gui:=true world_file:='$(find fira_challenge_env)/worlds/challenge.world'